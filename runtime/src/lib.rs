    ...
    ($func_id:expr, $env:expr) => {
        ...
        match $func_id {
            ...
            0xfeffff00 => {
                ...
                let input: $crate::LoggerExt = env.read_as_unbounded(env.in_len())?;
                ...
                match input.level {
                    ...
                    2 => {
                        $crate::log::warn!(target: target, "⚠️  {}", args);
                    }
                    3 => {
                        $crate::log::info!(target: target, "❤️  {}", args);
                    }
                    4 => {
            ...
            _ => {
                ...
                return Err($crate::DispatchError::Other("Unimplemented func_id"));
            }
        }
    };
}
